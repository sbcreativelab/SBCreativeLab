        ...
        <div>
            <div className="projects-header">
                ...
                <div className={`${isExtraSmallScreen ? 'tablist-small' : 'tablist'} header-right`}>
                    <a href={applicationLink} target="_blank" className='tab' rel="noreferrer">Apply</a>
                            ...
                            <div className="col-10 col-sm-10">
                                <div style={{ overflow: 'hidden' }} >
                                    <div className="animate-slideup py-3">
                                        <a target="_blank" href={applicationLink} className="button text-center" rel="noreferrer">
                                            Apply
                                        </a>
                                    </div>
                                </div>
                                <div className={`arrow ${isExtraSmallScreen ? 'hidden' : ''} fadeInOut`} style={{ top: "-8px", left: "250px", position: "absolute" }}>
                                    <img src="/images/projects/arrow.png" alt="" />
                                </div>
                            </div>
                        </div>
                        {isExtraSmallScreen ? <div /> :
                            <div className="imageContainer" style={{ position: "absolute" }}>
                                <HashLink smooth to={`#about`} className='arrow-down'>
                                    <img style={{ position: "absolute", bottom: "-5%", left: "50%", transform: "translate(-50%,-50%)" }} src="/images/projects/arrow-down.png" alt="" />
                                </HashLink>
                            </div>}
                    </div>
                    {isExtraSmallScreen ? <div /> : <div>
                        <div className='prototypeGraphic' style={{ position: 'absolute' }}>
                            <img id="prototypeGraphic" src="/images/projects/prototype.png" alt="" />
                        </div>
                    </div>}
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 b1">
                                    <div className="question mb-5">
                                        ...
                                        <div className="b2">
                                            All SBCL members can <span><a style={{ textDecoration: 'underline' }} href={applicationLink} target="_blank" rel="noreferrer">apply.</a></span> All experience levels are welcome (individuals with no experience as well)!
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="container-fluid">
                    <div className="row d-flex flex-column align-items-center section-4 text-center">
                        ...
                        <div className="b2 pl-4 pr-4" >
                            Applications for our {currentQuarter} Projects Teams are <span><a style={{ textDecoration: 'underline' }} href={applicationLink} target="_blank" rel="noreferrer">open now!</a></span>
                        </div>
